  ...
  return (
    <main className="bg-green-950">
      ...
      <div className="flex flex-col items-center">
        <p className="text-white font-bold text-3xl text-center tracking-tighter mt-5 md:text-7xl ">
          DESCUENTO ESPECIAL
        ...
        <p className="text-white tracking-tighter  mx-2 mt-5">
          Este curso de Hidroponía es el puente de contacto con un experto en el
          tema, que te llevará de la mano en todo el camino,
          <br /> allanando los obstáculos con su conocimiento y vasta
          experiencia lograda a lo largos de muchos años.
        </p>
        <Button
          size="lg"
          className='mt-5 bg-black hover:bg-slate-800'
          onClick={() => {
            push("https://wa.link/6nvgae");
            trackEvent("InitiateCheckout", { value: 29.99, currency: "USD" });
          }}
